...
import { StatusTag } from '../Task/TaskDetail';
import { Tooltip } from 'antd';
import ImageWithPreview from '../../components/images/ImageWithPreview';
...
const TableProject = ({data}) => {
  ...
  return (
    <div className='p-4'>
      <button className='flex items-center rounded bg-blue-primary px-3 py-2 text-white hover:bg-blue-600 mb-4'
